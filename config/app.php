...
return [
    ...
    'App' => [
        ...
        // Cambia qui per settare la lingua globale del cms
    ...
    'Cache' => [
        'default' => [
			...
			'prefix' => CACHE_PREFIX . 'cache_default_'
        ],
		'short' => [
			//'className' => 'Apcu', // va abilitata lato server
			'className' => FileEngine::class,
			'duration' => '+1 hours',
			'path' => CACHE . 'short' . DS,
			'prefix' => CACHE_PREFIX . 'cache_short_'
		],		
		'long' => [
			'className' => FileEngine::class,
			'duration' => '+1 month',
			'path' => CACHE . 'long' . DS,
			'prefix' => CACHE_PREFIX . 'cache_long_'
		],
        ...
        '_cake_core_' => [
            'className' => FileEngine::class,
            'prefix' => CACHE_PREFIX . 'cache_core_',
        ...
        '_cake_model_' => [
            'className' => FileEngine::class,
            'prefix' => CACHE_PREFIX . 'cache_model_',
        ...
        '_cake_routes_' => [
            'className' => FileEngine::class,
            'prefix' => CACHE_PREFIX . 'cache_routes_',
    ...
    'Log' => [
		...
		'access_fail_frontend' => [
            'className' => FileLog::class,
            'path' => LOGS,
            'file' => 'access_fail_frontend',
			'scopes' => ['access_fail_frontend'],
			'levels' => [],
        ],
		'contacts' => [
            'className' => FileLog::class,
		...
		'cookie_preferences' => [
            'className' => FileLog::class,
            'path' => LOGS,
            'file' => 'cookie_preferences',
			'scopes' => ['cookie_preferences'],
			'levels' => [],
        ],
		'logout' => [
            'className' => FileLog::class,
    ...
    'Session' => [
        'defaults' => 'cake',		
		'cookie' => 'WM',				
		'timeout'  => 30 * 24 * 60,  // in minuti (un mese di inattività richiede un nuovo login)		
		'ini' => array(
		    'session.cookie_lifetime' => 30 * 24 * 60 * 60, // durata del cookie (in secondi) per "sopravvivere" al fatto che il session timeout scade quando si chiude il browser
